...
| `BUILD` `50a → 51a → … → 56a`, `index.html ?v=56a` | aturan cache-busting repo |
...
Angka repo yang terverifikasi hari ini: **11 hero**, 13 tipe musuh, 5 arena, 6 bab kampanye, 13 tier pangkat, 5 skin + 2 aksesori, 35 file `data/*.json`, 104 file `js/*.js` (45 sistem, 23 layar).
