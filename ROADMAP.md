...
- [~] 47. **Foto mutasi per hero** — overlay `mut_*.png` DICABUT; 44 foto (2 tingkat × 2 pose × 11 hero) via `tools/mutation-art/PROMPTS.md` + `tools/build-mutation-sprites.py`. Progres: **31/44** — frame terkunci ke sprite dasar (Δ ≤ 0.01) supaya animasi idle/attack, balik kiri-kanan & bob tidak melompat
