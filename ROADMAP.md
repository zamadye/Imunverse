...
| `BUILD` `50a → 51a → … → 58a`, `index.html ?v=58a` | aturan cache-busting repo |
...
Angka repo yang terverifikasi hari ini: **11 hero**, 13 tipe musuh, 5 arena, 6 bab kampanye, 13 tier pangkat, 5 skin + 2 aksesori, 35 file `data/*.json`, 105 file `js/*.js` (46 sistem, 23 layar).
