...
export const THIRD_PERSON = {
  ANCHOR_Y: 0.62,          // posisi layar player (0.5 = tengah) — di bawah pusat
  FOLLOW_RATE: 6.0,        // smoothing posisi (≈ lerp 0.09/frame @60fps)
  LOOK_MAX: 150,           // px dunia — maksimum look-ahead ke arah gerak
  HEADING_RATE: 2.6,       // heading dihaluskan pelan → terlambat saat belok
  ZOOM_BASE: 1.32,         // baseline zoom (karakter lebih besar & jelas)
  ZOOM_IDLE: 1.07,         // diam → mendekat (lebih besar lagi)
