...
function shouldRun(meta = STATE.meta) {
  // RONDE-7: TUTORIAL DIHAPUS total atas permintaan pemilik game — overlay
  // gelembung/jari penunjuk mengganggu pembukaan (muncul tepat saat wave 1
  // ramai). Seluruh API modul tetap ada (no-op) supaya pemanggil tidak pecah:
  // isTutorialActive() selalu false → gerbang spawn/misi/skip jalan normal.
  return false;
}
