...
try {
  ...
  log('disclosure-run1-shop-open', disc1.shop === true, JSON.stringify(disc1));
  log('disclosure-run1-roster-hidden', disc1.roster === false);
  ...
  log('disclosure-run5-unlocked', disc2.roster && disc2.bag && disc2.bp, JSON.stringify(disc2));
  log('disclosure-rank-still-hidden-until-10', disc2.rank === false);
